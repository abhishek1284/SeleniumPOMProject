...
public class JobTitleTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 3️⃣ Click Job Title dropdown to open
            WebElement jobTitleDropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
                    "//label[text()='Job Title']/../following-sibling::div//div[@class='oxd-select-text-input']")));
            jobTitleDropdown.click();

            // 4️⃣ Get all Job Title options
            ...
            for (int i = 0; i < jobOptions.size(); i++) {
                // Reopen dropdown
                jobTitleDropdown = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
                        "//label[text()='Job Title']/../following-sibling::div//div[@class='oxd-select-text-input']")));
                jobTitleDropdown.click();
                ...
                if (employees.size() > 0) {
                    System.out.println("Employee List updated. Total employees: " + employees.size() + " ✅");
                } else {
                    System.out.println("No employees found for this Job Title ❌");
                }
            }
