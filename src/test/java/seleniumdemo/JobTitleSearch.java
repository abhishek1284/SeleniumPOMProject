...
public class JobTitleSearch {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement supportOption = wait.until(ExpectedConditions.visibilityOfElementLocated(
            ...
            // 6️⃣ Wait for Employee List and count total employees
            ...
            System.out.println("Total employees for 'Support Specialist': " + totalEmployees);

            // Optional: Print employee names
            for (WebElement emp : employees) {
                System.out.println(emp.getText());
            }

            // 7️⃣ Keep screen visible for 2 seconds
            try {
                Thread.sleep(2000);
